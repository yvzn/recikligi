...
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description)
SELECT UUID(), r.id, t.id, '', 'doit être déposé dans un conteneur spécifique'
FROM translation_locale t, recyclable_status r
...
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description)
SELECT UUID(), r.id, t.id, '', 'il n''y a pas suffisamment d''informations sur le recyclage de cet objet'
FROM translation_locale t, recyclable_status r
