...
INSERT INTO recyclable_status (id, name) VALUES (UUID(), 'recyclable-if-empty');

INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'à jeter', 'ne peut pas être recyclé' FROM translation_locale t, recyclable_status r WHERE t.name = 'fr' AND r.name = 'not-recyclable';
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'à recycler', 'en sac jaune ou bac de tri' FROM translation_locale t, recyclable_status r WHERE t.name = 'fr' AND r.name = 'recyclable';
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'colonne à verre', 'à déposer dans le conteneur approprié' FROM translation_locale t, recyclable_status r WHERE t.name = 'fr' AND r.name = 'glass';
...
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'à composter', 'en composteur individuel ou collectif' FROM translation_locale t, recyclable_status r WHERE t.name = 'fr' AND r.name = 'compost-pile';
...
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'à recycler si vide', 'une fois vidé de son contenu, en sac jaune ou bac de tri' FROM translation_locale t, recyclable_status r WHERE t.name = 'fr' AND r.name = 'recyclable-if-empty';

INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'throw away', 'cannot be recycled' FROM translation_locale t, recyclable_status r WHERE t.name = 'en' AND r.name = 'not-recyclable';
...
INSERT INTO recyclable_status_translation(id, recyclable_status_id, translation_locale_id, text, description) SELECT UUID(), r.id, t.id, 'recycle when empty', 'once empty, can be recycled into appropriate container' FROM translation_locale t, recyclable_status r WHERE t.name = 'en' AND r.name = 'recyclable-if-empty';
